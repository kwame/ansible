...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_check" {
  count               = 1
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.cpu-utilization-check"
...
resource "aws_cloudwatch_metric_alarm" "disk_space_utilization_ansible_client_node" {
  count               = 1
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.disk-space-utilization-alarm"
  comparison_operator = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "status_check_failed_system" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.status-check-failed-system"
  comparison_operator = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "status_check_failed_instance" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.status-check-failed-instance"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
...
resource "aws_cloudwatch_metric_alarm" "memory_utilization_ansible_client_node" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.memory_utilization_ansible_client_node"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "swap_utilization_ansible_client_node" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.swap_utilization_ansible_client_node"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "memory_available_ansible_client_node" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.memory_available_ansible_client_node"
...
resource "aws_cloudwatch_metric_alarm" "memory_used_ansible_client_node" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.memory_used_ansible_client_node"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "swap_used_ansible_client_node" {
  count               = "1"
  alarm_name          = "${var.environment}.ansible_client_node.${element(aws_instance.ansible_client_node.*.id, count.index)}.swap_used_ansible_client_node"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "2"
